					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="/l" class="active">Home</a></li>
					...
					<tbody>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="/data_file/{{ $krj->gambar }}" alt="" height="100px" width="100px"></a>
							</td>
							...
							<td class="cart_price">
								<p>Rp. {{ number_format($krj->harga) }}</p>
							</td>
							<td class="cart_quantity">
                                {{ $krj->jumlah }}
							</td>
							<td class="cart_total">
								<p class="cart_total_price">Rp. {{ number_format($krj->harga * $krj->jumlah) }}</p>
							</td>
						</tr>
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							<li>Cart Sub Total <span>Rp. {{ number_format($total) }}</span></li>
